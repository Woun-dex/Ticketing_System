        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div class="flex items-center justify-between">
            ...
            <nav class="flex items-center gap-4">
              <a routerLink="/admin/events" class="text-gray-300 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-gray-700">
                Events
              </a>
              <a routerLink="/queue" class="text-gray-300 hover:text-white transition-colors px-3 py-2 rounded-lg hover:bg-gray-700">
                Queue
              </a>
            </nav>
          </div>
          ...
          <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-purple-500 transition-colors">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-white mt-1">{{ totalEvents() }}</p>
              </div>
          ...
          <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-green-500 transition-colors">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-white mt-1">{{ publishedEvents() }}</p>
              </div>
          ...
          <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-yellow-500 transition-colors">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-white mt-1">{{ draftEvents() }}</p>
              </div>
          ...
          <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 hover:border-red-500 transition-colors">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-3xl font-bold text-white mt-1">{{ cancelledEvents() }}</p>
              </div>
        ...
        <div class="bg-gray-800 rounded-xl p-6 border border-gray-700 mb-8">
          ...
          <div class="flex flex-wrap gap-4">
            <a routerLink="/admin/events/create" 
               class="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium rounded-lg hover:from-purple-700 hover:to-pink-700 transition-all shadow-lg hover:shadow-purple-500/25">
            ...
            <a routerLink="/admin/events" 
               class="inline-flex items-center gap-2 px-6 py-3 bg-gray-700 text-white font-medium rounded-lg hover:bg-gray-600 transition-all">
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gray-800 rounded-xl border border-gray-700">
          <div class="p-6 border-b border-gray-700">
            <div class="flex items-center justify-between">
              ...
              <a routerLink="/admin/events" class="text-purple-400 hover:text-purple-300 text-sm font-medium">
                View all →
              </a>
            </div>
          </div>
          ...
          @if (adminService.loading()) {
            ...
            <div class="p-8 text-center">
              ...
              <a routerLink="/admin/events/create" class="text-purple-400 hover:text-purple-300 text-sm mt-2 inline-block">
